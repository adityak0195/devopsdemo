--------------------------------------------------------------
--------------------------------------------------------------
print '-- GetWorkingTimeRailInSeconds1Core';
--------------------------------------------------------------
--------------------------------------------------------------

IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'GetWorkingTimeRailInSeconds1Core'))
drop FUNCTION GetWorkingTimeRailInSeconds1Core;
GO
CREATE FUNCTION  GetWorkingTimeRailInSeconds1Core   
( @StartDate DateTime2,
  @EndDate DateTime2,
  @Machine varchar(255)
)  
